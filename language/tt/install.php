...
$lang = array_merge($lang, array(
	...
	<ul>
		...
		<li>SQLite 2.8.2+</li>
		<li>Firebird 2.1+</li>
		<li>MS SQL Server 2005 or above (directly or via ODBC)</li>
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> 'фо̄рӯмың турында аңлатма биреўче қысқа генә йазыў',
	'CONFIG_SITENAME'				=> 'sinnindomayn.com',
	...
	'FORUMS_FIRST_CATEGORY'			=> 'синнең беренче "ка̄те̄го̄рийә"ң',
	'FORUMS_TEST_FORUM_DESC'		=> 'беренче фо̄рӯмыңға аңлатма.',
	'FORUMS_TEST_FORUM_TITLE'		=> 'беренче фо̄рӯмың',

	'RANKS_SITE_ADMIN_TITLE'		=> 'са̄йт башлығы',
	...
	'TOPICS_TOPIC_TITLE'			=> 'phpBB3ға рәхим ейтеңез',
));
