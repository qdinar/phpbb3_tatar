...
*
* Razani тәрҗемәсе ( http://tmf.org.ru/viewtopic.php?f=5&t=18&start=30#p96 ), qdb төзәтте.
*
*/
...
$help = array(
	...
	array(
		...
		1 => 'Cезгә программа кисәген яки тигез киңлектәге хәрефле (Соurier) текст күрсәтергә кирәк булса, сез аны <strong>[code][/code]</strong> теглары эченә урнаштырырга тиеш, мәсьәлән<br /><br /><strong>[code]</strong>echo &quot;This is some code&quot;;<strong>[/code]</strong><br /><br /><strong>[code][/code]</strong> теглары эчендә барлык форматлау элементлары сакланачак. php теле синтаксисын аерып күрсәтүне <strong>[code=php][/code]</strong> теглары ярдәмендә кабызып була, бу, җиңел укылышын арттырыр өчен, php-кодлы хәбәр язганда киңәш ителә. '//Razani-ныңкыны төзәтеп, qdb тәрҗемәсе
	), 
	array(
		0 => '--',
		1 => 'Исемлекләр төзү'
	...
	array(
		...
		1 => 'Хәзер хәбәрнең теләсә кайсы өлешенә BBCode ның яңа <strong>[attachment=][/attachment]</strong> тегы ярдәмендә конференция администраторы рөхсәте һәм сезнең тиешле хокукларыгыз булса, файл беркетеп була. Хәбәрләр урнаштыру битендә хәбәргә файллар беркетү өчен ачылучы исемлек (тиешле төймә белән) урнаштырылган.'
	),
	array(
		0 => '--',
		1 => 'Төрлеләр'
